...
model = Trainer.train_model(x, y, model, 128, 100)
#
# # Save trained model and tokenizer for later usage
Trainer.save_model(model, 'model_trump_final.h5')
Trainer.save_tokenizer(tokenizer, 'tok_trump_final.pkl')
'''
...
generated = Generator.generate_seq(model, tokenizer, seq_length, seed_text, 10, 30)
