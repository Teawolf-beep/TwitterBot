...
Trainer.save_model(model, 'model_5690.h5')
Trainer.save_tokenizer(tokenizer, 'tokenizer.pkl')
...
model = Generator.load_trained_model('model_5690.h5')
tokenizer = Generator.load_tokenizer('tokenizer.pkl')
...
generated = Generator.generate_seq(model, tokenizer, seq_length, seed_text, 30)
print(generated)
